            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="文章缩略图" prop="img">
                    <Upload
                        ...
                        :data="uploaddatas"
                        type="drag"
                        action="http://localhost:3000/api/addnotice_news"
            ...
            <Form ref="editformValidate" :model="editformValidate" :rules="editruleValidate" :label-width="80">
                ...
                <FormItem label="文章缩略图" prop="img">
                    ...
                    <Upload
                        ...
                        :data="uploaddatas"
                        type="drag"
                        action="http://localhost:3000/api/editnotice_news"
                        style="display: inline-block;width:58px;">
                        <div style="width: 58px;height:58px;line-height: 58px;">
                            <Icon type="ios-camera" size="20"></Icon>
                        </div>
...
<script>
import {notice_news_release,notice_news,delnotice_news} from '@/api/front_management'
...
export default {
  ...
  methods: {
    gorelease(){
        ...
        notice_news_release(id).then((res)=>{
            var data = res.data;
